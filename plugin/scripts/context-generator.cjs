...
`):null}function yt(n,e,t,s,r,o){let i=[];o?i.push(...Ye(n)):i.push(...ve(n));let d=null,a="",p=!1;for(let l of e)if(l.type==="summary"){p&&(i.push(""),p=!1,d=null,a="");let _=l.data,g=st(_.displayTime);o?i.push(...Je(_,g)):i.push(...$e(_,g))}else{let _=l.data,g=ot(_.files_modified,r,_.files_read),E=rt(_.created_at),h=E!==a,f=h?E:"";a=E;let m=t.has(_.id);if(g!==d&&(p&&i.push(""),o?i.push(...Ve(g)):i.push(...Ue(g)),d=g,p=!0),m){let S=Lt(_,s);o?i.push(...qe(_,E,h,S,s)):(p&&!o&&(i.push(""),p=!1),i.push(...ke(_,f,S,s)),d=null)}else o?i.push(Ke(_,E,h,s)):i.push(xe(_,f,s))}return p&&i.push(""),i}function it(n,e,t,s,r){let o=[],i=It(n);for(let[d,a]of i)o.push(...yt(d,a,e,t,s,r));return o}function at(n,e,t){return!(!n.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function dt(n,e){let t=[];return e?(t.push(...x("Investigated",n.investigated,c.blue)),t.push(...x("Learned",n.learned,c.yellow)),t.push(...x("Completed",n.completed,c.green)),t.push(...x("Next Steps",n.next_steps,c.magenta))):(t.push(...U("Investigated",n.investigated)),t.push(...U("Learned",n.learned)),t.push(...U("Completed",n.completed)),t.push(...U("Next Steps",n.next_steps))),t}function ct(n,e){return e?ze(n):we(n)}function pt(n,e,t){return!j(e)||n.totalDiscoveryTokens<=0||n.savings<=0?[]:t?Qe(n.totalDiscoveryTokens,n.totalReadTokens):Fe(n.totalDiscoveryTokens,n.totalReadTokens)}var Dt=ut.default.join((0,lt.homedir)(),".claude","plugins","marketplaces","customable","plugin",".install-version");function vt(){try{return new F}catch(n){if(n.code==="ERR_DLOPEN_FAILED"){try{(0,mt.unlinkSync)(Dt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw n}}function Ut(n,e){return e?Ze(n):Pe(n)}function xt(n,e,t,s,r,o,i){let d=[],a=J(e);d.push(...et(n,a,s,i));let p=t.slice(0,s.sessionCount),l=Re(p,t),_=ee(e,l),g=Me(e,s.fullObservationCount);d.push(...it(_,g,s,r,i));let E=t[0],h=e[0];at(s,E,h)&&d.push(...dt(E,i));let f=Z(e,s,o,r);return d.push(...ct(f,i)),d.push(...pt(a,s,i)),d.join(`
