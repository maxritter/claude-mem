...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),u=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",l={...s,location:u};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},m=new G;var ht={};function ft(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,pe.fileURLToPath)(ht.url))}var St=ft(),I=y.get("CLAUDE_MEM_DATA_DIR"),H=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,ae.homedir)(),".claude"),Bt=(0,h.join)(I,"archives"),Gt=(0,h.join)(I,"logs"),Ht=(0,h.join)(I,"trash"),Wt=(0,h.join)(I,"backups"),Yt=(0,h.join)(I,"modes"),Vt=(0,h.join)(I,"settings.json"),ce=(0,h.join)(I,"claude-mem.db"),qt=(0,h.join)(I,"vector-db"),Kt=(0,h.join)(H,"settings.json"),Jt=(0,h.join)(H,"commands"),zt=(0,h.join)(H,"CLAUDE.md");function me(r){(0,de.mkdirSync)(r,{recursive:!0})}function ue(){return(0,h.join)(St,"..")}var U=class{db;constructor(e=ce){e!==":memory:"&&me(I),this.db=new le.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn()}initializeSchema(){this.db.run(`
  ...
  `).all(e,...s,...o,t.totalObservationCount)}function K(r,e,t){return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+Se)}function Ot(r){return r.replace(/\//g,"-")}function Ct(r){try{if(!(0,P.existsSync)(r))return{userMessage:"",assistantMessage:""};let e=(0,P.readFileSync)(r,"utf-8").trim();if(!e)return{userMessage:"",assistantMessage:""};let t=e.split(`
